    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: InkWell(onTap: state.sendComment(),child: Icon(FluentIcons.send_28_filled,size: 23*iconSize,color: const Color.fromRGBO(32, 197, 122, 1),)),
        ),
      ),
    );
  }
