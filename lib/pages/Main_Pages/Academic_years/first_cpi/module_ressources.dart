...
String? chaine3;
  ...
  Widget build(BuildContext context) { TextStyle kresources=GoogleFonts.inter(fontSize: 18.sp,fontWeight: FontWeight.w500,color: Colors.white);
    ...
    return Scaffold(backgroundColor: const Color.fromRGBO(35, 47, 56, 1), body: SingleChildScrollView(
      child: Padding(
      ...
      Row(children: [Image(image:const AssetImage('lib/images/drive.png'),width: 30.w,height: 30.h,),SizedBox(width: 10.w,),Text('Google drives',style:kresources),SizedBox(height: 13.h,),
      ],),
      ...
      Row(children:[if(url4!=null&& url5!=null&&url6!=null)Image(image:const AssetImage('lib/images/youtube.png'),height: 70.h,width: 70.w),SizedBox(width: 6.w,),if(url4!=null&& url5!=null&&url6!=null)Text('Youtube channels',style:kresources)
