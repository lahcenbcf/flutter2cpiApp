...
class Post_Model extends ChangeNotifier {
  ...
  addPost(String title, String desc, File image, String imagePath,
    ...
    if(selectedIndex==1 || selectedIndex==2 ||(selectedIndex==3 && postType=="infoPost")){
      ...
      Post p = Post(
      profilePic:imageBytes,//user info
      image: imageBytes,
      links: [],//provides links of user
      type: postType,
      likesCount: 0,
      commentsCount: 0,
      title: title,
    ...
    if(postType=="StuckPosts"){
      ...
      //artcle 
      PostInfo p=PostInfo(image: imageBytes, title: title, description: desc, date: formattedDate,//pathImage:imagePath
      );
      articlePosts.add(p);
    }
