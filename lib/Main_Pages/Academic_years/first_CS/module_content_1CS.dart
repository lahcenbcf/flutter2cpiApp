...
class Module_content_1CS extends StatefulWidget {
  Module_content_1CS({super.key, required this.title, required this.i});
  final String title;
  final int i;
  @override
...
final List<List<Widget>> content = [
  ...
  [
    Module_posts('Theeorie des langages'),
    Module_ressources_1CS(
  ...
  [
    Module_posts('Analyse numerique'),
    Module_ressources_1CS(
  ...
  [
    Module_posts('Langue Anglaise 1'),
    Module_ressources_1CS(
  ...
  [
    Module_posts('Intro à la sécurité'),
    Module_ressources_1CS(
  ...
  [
    Module_posts('Gestion de projet'),
    Module_ressources_1CS(
  ...
  [
    Module_posts('Langue Anglaise 2'),
    Module_ressources_1CS(
