...
class Module_ressources2 extends StatelessWidget {
  Module_ressources2(
      {super.key,
  ...
  Widget build(BuildContext context) {
    TextStyle kresources = GoogleFonts.inter(
          ...
          child: Padding(
            ...
            child:
              ...
              Row(
                children: [
                  Image(
                    image: AssetImage('lib/images/drive.png'),
                    width: 30.w,
                    height: 30.h,
                  ),
                  SizedBox(
              ...
              Row(
                children: [
                 if(url4!=null&& url5!=null&&url6!=null) Image(
                 ...
                 if(url4!=null&& url5!=null&&url6!=null) Text('Youtube channels', style: kresources)
                ],
              ),
              SizedBox(
                height: 20.h,
